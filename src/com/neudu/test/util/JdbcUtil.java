...
public class JdbcUtil {
    //static final 静态只读  不能改  相当于常量
    private static final String URL="jdbc:mysql://192.168.153.150:3306/db1?userUnicode=true&characterEncoding=utf8";
    private static final String USERNAME="root";
    private static final String PASSWORD="123456";
    //加载驱动   驱动只需加载一次，所以写在static里
    static {
        try {
    ...
    public static int executeUpdate(String sql,Object... params){
        ...
        try {
            pstmt=con.prepareStatement(sql);   //sql   就是sql语句 可变
            if (params!=null){
